...
import mtasa.client.classes.*;
import mtasa.client.enums.*;
import mtasa.client.returns.*;
...
extern class Functions {
	...
	**/
	static function dxConvertPixels(pixels: String, newFormat: DxPixelFormat, ?quality: Int = 80): String;
	...
	**/
	...
	static function dxCreateTexture(filePath: String, ?textureFormat: DxTextureFormat = ARGB, ?mipmaps: Bool = true,
		?textureEdge: DxTextureEdge = WRAP): DxTexture;
	...
	**/
	...
	static function dxDrawImageSection(posX: Float, posY: Float, width: Float, height: Float, u: Float, v: Float, usize: Float, vsize: Float,
		image: EitherType<DxTexture, String>, ?rotation: Float = 0.0, ?rotationCenterOffsetX: Float = 0.0, ?rotationCenterOffsetY: Float = 0.0,
		?color: Int = 1, ?postGUI: Bool = false): Bool;
	...
	**/
	...
	static function dxDrawMaterialLine3D(startX: Float, startY: Float, startZ: Float, endX: Float, endY: Float, endZ: Float, material: DxTexture,
		width: Float, ?color: Int = 1, ?postGUI: Bool = false, ?faceTowardX: Float = 0.0, ?faceTowardY: Float = 0.0, ?faceTowardZ: Float = 0.0): Bool;
	...
	**/
	...
	static function dxDrawMaterialSectionLine3D(startX: Float, startY: Float, startZ: Float, endX: Float, endY: Float, endZ: Float, u: Float, v: Float,
		usize: Float, vsize: Float, material: DxTexture, width: Float, ?color: Int = 1, ?postGUI: Bool = false, ?faceTowardX: Float = 0.0,
		?faceTowardY: Float = 0.0, ?faceTowardZ: Float = 0.0): Bool;
	...
	**/
	static function dxGetPixelsFormat(): DxPixelFormat;
